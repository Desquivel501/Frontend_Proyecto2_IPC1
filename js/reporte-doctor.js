const ruta = 'https://backend-ipc1-202010055.herokuapp.com/Doctores';
let plantilla = "";
var d = new Date();

function generar_reporte(){
    fetch('https://backend-ipc1-202010055.herokuapp.com/Doctores',{
        method: 'GET',
        })
        .then(res => res.json())
        .catch(err =>{
                                            ...
                                            for(var i in response){
                                                plantilla += `
                                                    <tr class="table-light ">
                                                        ...
                                                        <td style="text-align: center;">${response[i].Especialidad} </td>
 ...
 */
                                html2pdf().from(plantilla).save("reporte-doctor.pdf");
