...
function generar_reporte(){
    fetch('https://backend-ipc1-202010055.herokuapp.com/Med',{
        method: 'GET',
        })
        .then(res => res.json())
        .catch(err =>{
                                            ...
                                            for(var i in response){
                                                plantilla += `
                                                    <tr class="table-light ">
                                                        ...
                                                        <td style="text-align: center;">${response[i].Descripcion}</td>
                                                        <td style="text-align: center;">${response[i].Precio} </td>
 ...
 */
                                html2pdf().from(plantilla).save("reporte_medicamentos.pdf");
