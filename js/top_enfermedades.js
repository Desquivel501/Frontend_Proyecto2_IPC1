...
function top_enfermedades(){

    fetch('https://backend-ipc1-202010055.herokuapp.com/top_enfermedades',{
        method: 'GET',})
        .then(res => res.json())
        .catch(err =>{
...
*/
                            html2pdf().from(plantilla2).save("top_medicamentos.pdf");
