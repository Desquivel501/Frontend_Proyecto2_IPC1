...
function top_medicamentos(){

    fetch('https://backend-ipc1-202010055.herokuapp.com/top_med',{
        method: 'GET',})
        .then(res => res.json())
        .catch(err =>{
                ...
                <body>
                    ...
                    <tr class="information">
                        <td colspan="2">
                            <table>
                                <tr>
                                  <h1>Top Medicamentos Vendidos</h1>
...
*/
                            html2pdf().from(plantilla).save("top_medicamentos.pdf");
