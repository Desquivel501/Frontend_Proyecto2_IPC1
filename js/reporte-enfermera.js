const ruta = 'https://backend-ipc1-202010055.herokuapp.com/Enfermeras';
let plantilla = "";
var d = new Date();

function generar_reporte(){
    fetch('https://backend-ipc1-202010055.herokuapp.com/Enfermeras',{
        method: 'GET',
        })
        .then(res => res.json())
        .catch(err =>{
